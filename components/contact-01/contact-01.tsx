    ...
    <div className="text-center">
      ...
      <div className="max-w-screen-xl mx-auto py-24 grid md:grid-cols-2 lg:grid-cols-3 gap-16 md:gap-10 px-6 md:px-0">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <p className="mt-2 text-muted-foreground">Lun-Vie de 8am a 5pm.</p>
          <Link className="mt-4 font-medium text-primary" href="tel:2225-1707">
        ...
        <div className="text-center flex flex-col items-center">
          ...
          <Link className="mt-4 font-medium text-primary" href="https://www.tiktok.com/@asociacin.arca.de">
            asociacin.arca.de
          </Link>
        </div>
      </div>
