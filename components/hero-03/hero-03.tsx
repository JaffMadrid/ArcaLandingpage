...
const Hero03 = () => {
  return (
    <div className=" w-full flex flex-col gap-10 items-center justify-start py-12 px-6">
      <div className="text-center max-w-2xl">
        <h1 className="mt-1 text-4xl text-primary sm:text-5xl md:text-6xl font-bold !leading-[1.2] tracking-tight">
